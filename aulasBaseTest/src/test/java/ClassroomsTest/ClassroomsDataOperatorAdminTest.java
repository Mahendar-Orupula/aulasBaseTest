...
public class ClassroomsDataOperatorAdminTest extends BaseTest {
	LoginClass LC;
	
    HomePage1 HP;
	
	ClassroomPage CR;
	public ClassroomsDataOperatorAdminTest() {
		super();
	...
	@Test(priority=1, groups="DataOperator Classrooms Module")
	...
	@Test(priority=2, groups="DataOperator Classrooms Module")
	...
	@Test(priority=3, groups="DataOperator Classrooms Module")
	...
	@Test(priority=4, groups="DataOperator Classrooms Module")
	...
	@Test(priority=5, groups="DataOperator Classrooms Module")
	...
	@Test(priority=6, groups="DataOperator Classrooms Module")
