...
public class ClassroomsOperationsAdminTest extends BaseTest {
	LoginClass LC;
	
    HomePage1 HP;
	
	ClassroomPage CR;
	public ClassroomsOperationsAdminTest() {
		super();
	...
	@Test(priority=1, groups="Operations Classrooms Module")
	...
	@Test(priority=2, groups="Operations Classrooms Module")
	...
	@Test(priority=3, groups="Operations Classrooms Module")
	...
	@Test(priority=4, groups="Operations Classrooms Module")
	...
	@Test(priority=5, groups="Operations Classrooms Module")
	...
	@Test(priority=6, groups="Operations Classrooms Module")
